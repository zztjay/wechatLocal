...
// GetContactListService 获取联系人
func GetContactAllListService(queryKey string, req model.GetContactAllListModel) vo.DTO {
	return checkExIdPerformNoCreateConnect(queryKey, func(wxAccount wxface.IWXAccount, newIWXConnect bool) vo.DTO {
		loginState := wxAccount.GetLoginState()
		...
		return vo.NewSuccess(gin.H{
			"ContactList": dbUserInfo,
		}, "")

	})
}

// GetContactListService 获取全部联系人并同步
func SyncContactAllListService(queryKey string, req model.GetContactAllListModel) vo.DTO {
	return checkExIdPerformNoCreateConnect(queryKey, func(wxAccount wxface.IWXAccount, newIWXConnect bool) vo.DTO {
		loginState := wxAccount.GetLoginState()
		...
		// 查询所有好友
		req := GetContactListService(queryKey, *query)
